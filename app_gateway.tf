...
# Standard_v2 (sin WAF) es una decision deliberada de costo/escala para este
# nivel de trafico. Subir a WAF_v2 es un cambio de una linea si hace falta
# mas adelante.
#
...
# container_apps.tf), y WAF esta apagado por decision de costo.
resource "azurerm_application_gateway" "this" {
  ...
  #checkov:skip=CKV_AZURE_120:WAF_v2 no justificado por costo a este nivel de trafico - Standard_v2 alcanza
