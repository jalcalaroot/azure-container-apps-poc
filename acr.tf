# Azure Container Registry - Basic SKU alcanza para un registro de una sola
# imagen. Admin user deshabilitado a proposito: el Container App hace pull
# con su managed identity (ver identities.tf / role_assignments.tf), no con
# credenciales admin embebidas.
#
...
# policy) - no disponibles en Basic SKU y no justificados para un registro
# de hello-world con una sola imagen.
resource "azurerm_container_registry" "this" {
  #checkov:skip=CKV_AZURE_164:content trust requiere Premium SKU - no justificado para este volumen
  ...
  #checkov:skip=CKV_AZURE_167:retention policy requiere Premium SKU - una sola imagen (hello-world:latest)
